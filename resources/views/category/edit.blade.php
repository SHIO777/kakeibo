        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form class="mb-6" action="{{ route('category.update', $category->id) }}" method="POST">
            ...
            <div class="flex flex-col mb-4">
              ...
              <input class="border py-2 px-3 text-grey-darkest" type="text" name="category" id="category" value="{{$category->category}}">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="description">Description</label>
              <input class="border py-2 px-3 text-grey-darkest" type="text" name="description" id="description" value="{{$category->description}}">
            </div>
